...
$id = session()->get('userSessionId') ?? null;
?>
...
<body>
    ...
    <header>
        <div class="menu">
            <ul class="max-w-[2200px] w-full flex justify-between items-center">
                ...
                <div class="w-full flex justify-center items-end flex-col">
                    <?php if ($id !== null) : ?>
                        <form class="menu-item" method='post' action="<?= base_url("user/logout/") . $id ?>">
                            <?= csrf_field() ?>
                    ...
                    <li id="toggle-menu" class="menu-toggle">
                        <button id="menuToggle">&#9776;</button>
                    </li>
                    <?php if ($id === null) : ?>
                        <li id="list-toggle" class="menu-item max-w-[350px] w-full flex items-center justify-center hidden">
                            <a href="/students">Students</a>
                        </li>
                        <li id="list-toggle2" class="menu-item max-w-[350px] w-full flex items-center justify-center hidden">
                            <a href="/user/login">Login</a>
                        </li>
                        <li id="list-toggle3" class="menu-item max-w-[350px] w-full flex items-center justify-center hidden">
                            <a href="/user/register">Register</a>
                        </li>
                    <?php endif; ?>

                    <?php if ($id !== null) : ?>
                        <form method='post' action="<?= base_url("user/logout/") . $id ?>" id="list-toggle4" class="menu-item max-w-[350px] w-full flex items-center justify-center hidden method='post' action=">
                            <?= csrf_field() ?>
                            <input type="hidden" name="_method" value="DELETE" />
    ...
    <script>
        $(document).ready(() => {
            $(' #toggle-menu').click(() => {
                $('#list-toggle').toggle(200);
                $('#list-toggle2').toggle(300);
                $('#list-toggle3').toggle(400);
                $('#list-toggle4').toggle(500);
            });
        });
    </script>
